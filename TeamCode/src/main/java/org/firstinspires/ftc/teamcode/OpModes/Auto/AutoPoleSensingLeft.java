...
@Disabled
public class AutoPoleSensingLeft extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        robot.drive.right().goDist(1 * inchesPerBox, 0.55);
        ...
        robot.drive.backward().goDist(.25 * inchesPerBox, 0.45);
        ...
        for (int i = 0; i < ITERATIONS; i++) {
            ...
            robot.drive.forward().bumperGoDist(0.75 * inchesPerBox, robot.bumpSensorLeft, robot.bumpSensorRight);
        ...
        robot.drive.backward().goDist((id - 1.2) * inchesPerBox, 0.5);
        robot.sleep(.2);
