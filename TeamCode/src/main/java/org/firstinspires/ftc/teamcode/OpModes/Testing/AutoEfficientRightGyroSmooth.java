...
public class AutoEfficientRightGyroSmooth extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.drive.forward().goDistSmooth(.85 * inchesPerBox, 0.5);
        robot.sleep(0.2);
        ...
        robot.drive.forward().goDist(1 * inchesPerBox, 0.5);
        robot.sleep(0.2);
        ...
        robot.drive.forward().goDistSmooth(1.1 * inchesPerBox + 1.5, 0.5);
        robot.sleep(0.2);
